          ...
          {displayedProducts.map((product) => (
            ...
            >
              ...
              <div className="relative aspect-[4/5] bg-stone-100 overflow-hidden border-b border-stone-100">
                ...
                <div className="absolute inset-x-0 bottom-0 p-4 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 z-10">
                  <button
                    ...
                    className="w-full bg-[#2c302e] hover:bg-black text-white py-3 px-4 font-semibold text-sm uppercase tracking-widest flex items-center justify-center gap-2 rounded-none cursor-pointer"
                  >
                    <ShoppingBag size={16} />
                    Ajouter
                  </button>
              ...
              <div className="p-6 flex flex-col flex-1">
                <Link href={`/products/${product.id}`} className="block hover:text-[#8c7b65] transition-colors group-hover:text-[#8c7b65]">
                  <h3 className="text-lg font-bold text-[#2c302e] mb-2 transition-colors">
                    {product.name}
                  </h3>
                </Link>
